 ...
 * <p>
 * {@link io.github.jaymcole.housegraph.ui.io.GraphFileIO} reuses the same index-based snapshot
 * shape ({@code GraphCanvas.GraphSnapshot} / {@code ClipboardNode} / {@code ClipboardDataEdge} /
 * {@code ClipboardFlowEdge}) built for copy/paste. Its {@code toJson}/{@code fromJson} conversion
