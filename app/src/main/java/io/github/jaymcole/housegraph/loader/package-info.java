 ...
 *
 * <p>Its own package, headless like {@code saveformat}, {@code plugin}, {@code cli}, {@code remote}
 * and {@code catalog}, because of who needs it. It cannot live in {@code housegraph-api}: the
 * snapshot records carry manual edge routing as {@code javafx.geometry.Point2D}, and {@code graph/}
 * never imports JavaFX. It must not live in {@code ui/} either — the callers are headless ones, and
 ...
 *
 * <p>The seam below it is {@code GraphSnapshot}: {@code saveformat.GraphFileIO} owns JSON and stops
